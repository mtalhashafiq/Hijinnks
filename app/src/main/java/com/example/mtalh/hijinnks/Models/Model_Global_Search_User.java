...
public class Model_Global_Search_User {
    ...
    public Model_Global_Search_User(String profile_name, String number_of_invites, String text_follow, int profile_image, int follow_background) {
