...
//import static com.example.mtalh.hijinnks.Fragments.ProfileFragment.list_profile_Invites_Rsvpd;

/**
 * Created by mtalh on 26-Oct-17.
 */

public class RecyclerAdapter_Home_Profile_Invites extends RecyclerView.Adapter<RecyclerAdapter_Home_Profile_Invites.RecyclerViewHolder> {
    static RecyclerAdapter_Home_Profile_Invites.ItemClickListener itemClickListener;
    ArrayList<Model_Profile_Invites_rsvpd> list_profile_invites_rsvpds = new ArrayList<>();
    Context context;
    boolean video_pause_play = false;

    public RecyclerAdapter_Home_Profile_Invites(ArrayList<Model_Profile_Invites_rsvpd> list_profile_invites_rsvpds, Context context) {
        this.list_profile_invites_rsvpds = list_profile_invites_rsvpds;
        this.context = context;
    }

    @Override
    public RecyclerAdapter_Home_Profile_Invites.RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.listrow_invites_profile__fragment, parent, false);
        RecyclerAdapter_Home_Profile_Invites.RecyclerViewHolder recyclerviewholder = new RecyclerAdapter_Home_Profile_Invites.RecyclerViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(final RecyclerAdapter_Home_Profile_Invites.RecyclerViewHolder holder, int position) {
    ...
    public void SsetClickListener(RecyclerAdapter_Home_Profile_Invites.ItemClickListener listener) {
